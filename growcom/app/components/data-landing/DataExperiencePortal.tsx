...
export const DATA_EXPERIENCE_LAYOUT_ID = "growcom-data-experience";
const LAYOUT_ID = DATA_EXPERIENCE_LAYOUT_ID;

type DataExperiencePortalProps = {
  open: boolean;
  onClose: () => void;
};

export default function DataExperiencePortal({ open, onClose }: DataExperiencePortalProps) {
  const { t } = useI18n();
  const portal = t.landing.data.portal;
