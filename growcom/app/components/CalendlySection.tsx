...
const CALENDLY_BASE =
  "https://calendly.com/pepelora-growcom/new-meeting?hide_landing_page_details=1&hide_gdpr_banner=1";
...
export default function CalendlySection() {
  ...
  const calendlyUrl = `${CALENDLY_BASE}&locale=${lang === "en" ? "en" : "es"}`;
  ...
  return (
    <section id="calendly" className="relative bg-white py-12 sm:py-24 overflow-hidden">
      ...
      <div className="mx-auto max-w-4xl px-4 text-center">
        <h2 className="mb-4 text-3xl font-black text-gray-900 sm:text-5xl">{t.calendly.title}</h2>
        <p className="mb-12 text-lg text-gray-600">{t.calendly.sub}</p>
        <div
